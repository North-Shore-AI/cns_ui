defmodule CnsUiWeb.CoreComponents do
  @moduledoc """
  Provides core UI components.
  """
  use Phoenix.Component
  use Gettext, backend: CnsUiWeb.Gettext
  ...
  @doc """
  Shows the flash group with standard titles and kinds.
  """
  ...
  def translate_error({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(CnsUiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CnsUiWeb.Gettext, "errors", msg, opts)
    end
  end
